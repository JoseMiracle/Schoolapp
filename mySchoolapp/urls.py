...
urlpatterns = [
    ...
    path('school-sessions', views.session_info, name = 'school_sessions'),
    ...
    path('start_session/ <session_id>', views.start_session, name= "start_session" ),
    path('subjectlist', views.subjectlist, name ="subjectlist"),
    path('remove-subject/<subject>', views.remove_subject, name = "remove-subject"),
